...
int main(int argc, char **argv) {
    ...
    while (1)
    {
        // Đọc data được lấy từ serial port
        bytesRead = read(serialPort, buffer_char, sizeof(buffer_char));
        0.9, 0.4, 0.1, 0.44 , ........, 3.8
        0.2, 0.4, 0.4, 0.21 , ........, 12.2

        // Kiểm tra nếu có data từ serial port
        if (bytesRead > 0) {

            // Xử lý data lấy được từ serial port
