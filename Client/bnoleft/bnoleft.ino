...
void setup() {
  ...
  if(udp.connect(IPAddress(10,42,0,1), 2000)) {
...
void loop() {
  ...
  //   Serial.print(",");
    ...
    String message = "0," + String(data[1],2)  + "," + String(data[2],2)  + "," + String(data[3],2)  + "," + String(data[4],2)  + "," + String(data[5],2)  + "," + String(data[6],2) 
